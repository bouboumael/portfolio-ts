...
import logo from '../assets/images/mael-logo-pins-200x200.png';
...
const NotFound = () => {
    useEffect(() => {
        ...
        anime({
            ...
            easing: "easeInOutSine",
            direction: "alternate",
            scale: [{ value: 1 }, { value: 1.4 }, { value: 1, delay: 550 }],
            rotateY: { value: "+=180", delay: 5000 }
        });
    },[])
    return (
        <div className={"flex flex-col justify-center items-center"}>
            <a target="_blank" href="/">
                <div className="container">
                    <div className="row">
                        <div className="w-full mt-14 md:mt-40 lg:mt-14 mb-5">
                            <svg width="100%" height={"100%"} viewBox="0 0 636 324" fill="none"
            ...
            <div className="text-notfound flex flex-col text-center justify-around p-10">
                <h1 className={"mb-10"}>Page introuvable</h1>
                <p className={"mb-5"}>Désolé mais nous avons beau avoir envoyé nos meilleurs techniciens,<br/> cette page reste perdue pour nous!</p>
                <p className={"mb-5"}>Ne risquez pas de vous perdre encore plus et retournez à la page d'accueil.</p>
                <p className={"mb-5"}>Demandez Maël, il saura vous accompagner pour trouver la meilleur solution.</p>
